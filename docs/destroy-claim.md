...
|`destrmodelVersionoyClaim`|SHOULD|Indicates which version of the Destroy Claim Model Specification was used to generate this Destroy Claim. [Semantic Versioning 2.0.0](https://semver.org/) MUST be used.|`String`|`1.0.0`|
